...
database_path = '/home/bogdan/library1.db'
 
# filename pattern
# Pattern to guess metadata from filenames
filename_pattern = u'(?P<author>.+) - (?P<title>[^_]+)'
...
library_path = u'/home/bogdan/Documents/Books'
...
# installation uuid
# Installation UUID
installation_uuid = '84d8a7c3-851c-4b5b-aee9-87130d7a36ca'
